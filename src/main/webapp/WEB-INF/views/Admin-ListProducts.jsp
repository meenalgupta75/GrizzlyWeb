...
<form>
                        ...
                        <tr>
                          ...
                          <td>
                            <center>
                              <a href="view.html?id=${product.productId}" class="btn btn-secondary form-rounded"  width="50px"> &emsp;View&emsp; 
                              </a>&emsp;&emsp;
								<input id="prodId" name="userId" type="hidden" value=${user.userId}>
								<c:choose>
								<c:when test = "${product.status=='0'}">
                              <a href="block.html?id=${product.productId}" class="btn btn-secondary form-rounded"> &emsp;Block&emsp; 
                              </a>&emsp;&emsp;</c:when>
                              <c:otherwise>
                              <a href="unblock.html?id=${product.productId}" class="btn btn-secondary form-rounded"> &emsp;Unblock&emsp; 
                              </a>&emsp;&emsp;
                              </c:otherwise>
                              </c:choose>
